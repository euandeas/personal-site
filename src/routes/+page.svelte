	...
	<div class="flex w-full flex-col border-b border-border pb-8 md:flex-row">
		...
		<div class="flex-1 pl-4">
			...
			<p class="pb-4 text-lg">
				...
				iplicit building cloud-based financial management solutions for mid-market organisations.
				I've been passionate about software development from a young age, starting out as a
				self-taught programmer before going on to earn an MSci in Computer Science from the
				University of Nottingham. My focus is primarily on back-end development, but I also have
				strong experience building websites, web apps, and mobile apps. I also have a strong
				interest in privacy and enjoy tinkering with technologies such as Linux and homelabbing.
			</p>
		</div>
	</div>
					...
					<div class="relative flex items-stretch">
						...
						<div class="relative flex w-1/12 flex-col items-center px-8">
							{#if i !== events.length - 1}
								<div class="absolute mt-2 h-full bg-black dark:bg-white" style="width: 2px;"></div>
							{/if}
	...
	<div class="flex w-full flex-col border-b border-border py-8 md:flex-row">
		<div class="flex-1 pr-4 pb-8 md:pb-0">
			...
			<p class="pb-4 text-lg">
				...
				university, I competed nationally at events like BUCS, HORR, and Henley Royal Regatta, and
				served as President of the boat club in my final year. Since leaving university I have
				continued to race and train with my local club. As a very demanding sport, it has taught me
				a lot about discipline and pushing my limits.
			</p>
			<p class="pb-8 text-lg">
				...
				peloton has further fueled my interest in the sport. This has also given me an interest in
				aiming to complete an Ironman within the next couple of years.
			</p>
		</div>
		<div class="flex pl-4">
			<img
